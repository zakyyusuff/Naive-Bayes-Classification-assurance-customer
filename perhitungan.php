...
echo "Jadi Probabilitas Status mahasiswa terklasifikasi '.<b><u>Lancar.'";
}
elseif ($total_k_lancar > $total_t_lancar) {
echo "Jadi Probabilitas Status mahasiswa terklasifikasi '.<b><u>Kurang Lancar.'";
}
else
  echo "Jadi Probabilitas Status mahasiswa terklasifikasi '.<b><u>Tidak Lancar.'";
