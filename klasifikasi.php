 ...
 <body> 
  ...
  <table border="6" cellpadding="10" style="border-color:#FFD700">
    <tr>
      ...
      <th style="background-color:#FF4500;"><center>Semester</th>
      <th style="background-color:#FF4500;"><center>Remedial</th>
    </tr>
    <tbody>
      <tr>
        <td align="center">
        ...
        <td align="center">
          <select name="input4" style="background-color: black">
            ...
            <option value="input4b">Mahasiswa</option>
        ...
        <td align="center">
          <select name="input5" style="background-color: black">
            ...
            <option value="input5c">< 5 Juta</option>
          </select>
        </td>
        <td align="center">
          <select name="input6" style="background-color: black">
            <option value="input6a">1 - 3</option>
            <option value="input6b">4 - 6</option>
            <option value="input6c">7 - 9</option>
          </select>
        </td>
        <td align="center">
          <select name="input7" style="background-color: black">
            <option value="input7a"> 1</option>
            <option value="input7b">3</option>
            <option value="input7c">< 5</option>
          </select>
        </td>
